...
- **ブランドの役割分担**:
  ...
  - **姉妹 `SeekMe`**: 【待つ・迎える再会】私を探している誰かに向けて、自分の目印（手紙）を置いておく（パッシブ・灯台型）

---

## 📜 2. 置き手紙のデータ項目・表示設計（シンプル＆プライバシー厳守）
...
手紙を置いた側（Aさん）の負担をゼロにして投稿数を最大化しつつ、探した側（Bさん）が安心して決済・eKYCできる**相互合意フロー**です。

```mermaid
sequenceDiagram
    autonumber
    actor A as 置き手紙をした人 (Aさん)
    actor B as 探していた知人 (Bさん)
    
    Note over A: ① 置き手紙を投稿 (完全無料・SMS認証)
...
4. **サブCTA**: 「あなたも大切な人に向けて手紙を置きませんか？（新規投稿）」
