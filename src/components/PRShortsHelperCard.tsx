...
[テロップ] 「二人の思い出」が、メッセージのパスワード。
[音声/ナレーション] 「共通の思い出クイズを正解しないと絶対に繋がらない安全なアプリ、ReMEETs。」

■ 0:08 - 0:12 (信頼・安心・差別化)
[映像] 海岸に漂うボトルメールと、メッセージを開封して微笑む人物。
...
■ 0:12 - 0:20
[映像] 相手が正解し、マッチング成立。メッセージ・連絡先が開通するエフェクト画面。
...
■ 0:05 - 0:12
[映像] メッセージ作成画面とAIモデレーション検閲ログ画面。
[テロップ] 共通の思い出クイズ＋AI検閲エンジンで悪質ユーザーを100%遮断
[音声/ナレーション] 「共通の思い出クイズを突破した面識者同士しか繋がれず、AI安全エンジンが24時間悪質メッセージを隔離。」

■ 0:12 - 0:20
[映像] 安心して大切な人へメッセージを届ける様子と、ReMEETs公式ロゴ。
[テロップ] 絆を安全に結び直す『ReMEETs』今すぐ無料作成
[音声/ナレーション] 「安心だからこそ、大切な人へ届く。あなたも二人の思い出で、新しい一歩を踏み出そう。」`;

  const geminiPrompt = `ReMEETsという、相手との共通の思い出クイズ（パスワード）を解かないとメッセージが開けない、ストーカー犯罪や不当出会いを完全に排除した日本初の再会アプリの紹介ショート動画（20秒）の台本を作成してください。
