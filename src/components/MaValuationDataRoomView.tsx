...
2. ビジネスモデル:
   完全無料投函 ＋ 照合成功時メッセージ開封・連絡先開示手数料モデル（単価: ${formatPlainYen(feePerOpening)}）
...
1. 【記憶の交差点】: 相手の連絡先が不明でも、「名前」や「共通の思い出の地」を手がかりにメッセージを届けられる。
2. 【2人しか解けない思い出クイズ】: 赤の他人や悪意の第三者の不正開封を物理的に100%防ぐ、心温まる独自の合意照合システム。
3. 【双方合意・明朗低価格（600円）】: メッセージの投函・検索は完全無料。お互いが再会を望んでクイズに正解した時だけメッセージが開通する安心インフラ。
...
- STEP 3【奇跡の再会】（開通手数料 600円税込）: 思い出クイズに正解し、双方合意・電子的宣誓を経てメッセージ本文・連絡先が開通。
