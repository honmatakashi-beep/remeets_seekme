...
認証が完了すると、メッセージの投函や思い出の検索機能をご利用いただけます。
...
--------------------------------------------------`,
  ...
  // 3. SMS電話番号認証
  {
    ...
    triggerEvent: 'メッセージ開封・連絡先開示前の電話番号認証手続き時',
    fromName: 'ReMEETs',
...
このコードを画面に入力してください（有効期限: 10分）。※他人に教えないでください。`,
  ...
  // 4. ボトル投函完了・控えメール
  {
    ...
    triggerEvent: 'ユーザーが新しいメッセージ（ボトルメール）を海へ流した直後',
    fromName: 'ReMEETs 運営事務局',
    fromEmail: 'no-reply@remeets.link',
...
お相手がすべてのクイズに正解すると、メッセージの開封と連絡先の受け取り手続きへと進みます。
...
--------------------------------------------------`,
  ...
  // 7. メッセージ開封 ＆ 連絡先開示完了
  {
    ...
    category: '再会マッチング',
    type: 'email',
    title: 'メッセージ開封 ＆ 連絡先開示完了通知メール',
    triggerEvent: 'お相手が思い出クイズに全問正解し、メッセージを開封・開示手続きを完了した時',
    fromName: 'ReMEETs 再会速報システム',
    fromEmail: 'reunion@remeets.link',
    subject: '【ReMEETs奇跡の再会】お相手がメッセージを開封し、連絡先が開示されました！🎉',
    bodyTemplate: `{{searcherName}} 様

おめでとうございます！ついに想いが届きました。

「{{targetName}} 様」があなたの思い出クイズにすべて正解し、
メッセージの開封および連絡先受取手続き（本人確認）を完了いたしました！
...
--------------------------------------------------`,
  ...
  // 8. メッセージ開封手数料（600円）決済領収メール (新設)
  {
    id: 'fee_receipt',
    category: '決済・領収書',
    type: 'email',
    title: 'メッセージ開封・連絡先開示手数料（600円）決済領収メール',
    triggerEvent: 'メッセージ開封・連絡先開示のStripe決済（600円 税込）が完了した直後',
    fromName: 'ReMEETs 決済窓口',
    fromEmail: 'payment@remeets.link',
    subject: '【ReMEETs】メッセージ開封・開示手数料の決済が完了いたしました（領収控え）🧾',
    bodyTemplate: `{{payerName}} 様

いつもReMEETsをご利用いただきありがとうございます。

メッセージの開封および想い出照合・連絡先開示システム利用料の決済が正常に完了いたしました。
領収情報およびご利用明細は以下の通りです。

--------------------------------------------------
【ご利用明細・領収書】
役務内容：メッセージ開封・想い出照合および連絡先開示システム利用料
...
開示されたメッセージおよびSNS連絡先は、マイページの「開封済みのメッセージ」より
いつでもご確認いただけます。
...
--------------------------------------------------`,
  ...
  // 11. AI安全隔離・警告通知メール (新設)
  {
    ...
    triggerEvent: '投稿されたメッセージがAI安全診断（個人情報の直接記載、誹謗中傷、ストーカー兆候等）に抵触して非公開化された時',
    fromName: 'ReMEETs 安全防衛システム',
    fromEmail: 'safety-bot@remeets.link',
    subject: '【重要・ReMEETs】投稿されたメッセージの安全確認・一時非公開について',
    bodyTemplate: `{{userName}} 様
...
メッセージの内容をご確認いただき、修正・再投稿を行っていただくか、
誤判定と思われる場合はサポート窓口までご連絡ください。

▼ マイページでメッセージの内容を確認・修正する
{{editUrl}}
...
--------------------------------------------------`,
    sampleData: {
      customerName: '田中 律子',
      ticketId: '2026-0815',
      contactSubject: 'メッセージの検索方法について教えてください',
      replyContent: 'お問い合わせいただきありがとうございます。\n自分宛てのメッセージは、トップページの検索窓にお名前（旧姓・ニックネーム含む）またはゆかりの地を入力していただくことで簡単に見つけることができます。\n万が一見つからない場合でも、「新着入荷通知アラート」を登録しておくと、今後あなた宛てのボトルが投函された際に自動でメールが届きますのでぜひご活用ください。'
    },
