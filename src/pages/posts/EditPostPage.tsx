    ...
    const fetchPost = async () => {
      try {
        ...
        setFormData({
          ...
          targetLastNameKana: data.target_last_name_kana || '',
          targetFirstNameKana: data.target_first_name_kana || '',
          targetNameKana: data.target_name_kana || '',
          targetMaidenNameKana: data.target_maiden_name_kana || '',
