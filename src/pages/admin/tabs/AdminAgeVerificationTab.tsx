                ...
                <div className="bg-white/90 backdrop-blur-md border border-emerald-200/80 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="mt-2 flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-emerald-600 font-semibold">
                      (<span className="font-serif font-bold">{ageVerificationLogs.length > 0 
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-800 flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-800 border border-emerald-300">
                          AI 真贋 <span className="font-serif font-bold">99.4</span>%
                        </span>
                      </h4>
                    ...
                    <div>
                      <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-700 border border-slate-300">
                          全 <span className="font-serif font-bold">{ageVerificationLogs.length}</span> 件
                        </span>
                      </h3>
                      ...
                      <>
                        ...
                        <div className="p-3.5 border-t border-slate-200/80 bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
                          <div className="text-slate-500 font-medium">
                            ...
                            <span className="font-serif font-bold text-slate-800">{(currentPage - 1) * agePerPage + 1}</span> 〜{' '}
                            <span className="font-serif font-bold text-slate-800">{Math.min(currentPage * agePerPage, filtered.length)}</span> 件を表示
                          </div>
