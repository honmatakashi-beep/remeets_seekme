...
const TermsContent = () => (
  <div className="space-y-6 text-brand-dark/90 text-[13px] leading-relaxed text-black font-sans">
    ...
    <section className="space-y-2">
      ...
      <ul className="list-disc pl-5 mt-2 space-y-1 leading-relaxed text-xs text-black">
    ...
    <section className="space-y-2">
      ...
      <p className="leading-relaxed text-xs text-black font-sans">
        ...
        規約違反が検知された場合、事前の警告なく対象投稿の非表示化やアカウントアタック行為のIP制限、アカウント凍結等を実施します。
      </p>
    </section>
    <section className="space-y-2">
...
const PrivacyContent = () => (
  <div className="space-y-6 text-brand-dark/90 text-[13px] leading-relaxed text-black font-sans">
    <section className="space-y-2">
      ...
      <p className="leading-relaxed text-xs text-black">当社は、本サービスの提供にあたり、ユーザーから以下の情報を収集することがあります。</p>
...
const CompanyPage = () => (
  <div className="max-w-4xl mx-auto px-6 py-12 font-sans text-black animate-in fade-in duration-300">
    ...
    <section className="space-y-2">
      <h3 className="text-lg font-bold mb-3 border-b border-brand-border pb-2 text-black font-serif">4. セキュリティ管理</h3>
      <p className="leading-relaxed text-xs text-black">
        通信はすべてSSL/TLSによって暗号化され、安全に保護されています。また、提出された身分証明書画像は本人確認審査完了後、法令に定める一定期間厳重に保管された後、速やかに安全消去されます。
      </p>
    </section>
    <div className="pt-4 border-t border-brand-border text-neutral-400 text-[10px] text-right font-sans">
      制定日：2026年8月15日
    </div>
  </div>
);
...
export const CompanyPage = () => (
  <div className="p-4 sm:p-6 bg-white rounded-3xl shadow-sm border border-brand-border/60 max-w-3xl mx-auto my-6 font-sans">
    <div className="border-b border-brand-border/80 pb-4 mb-6">
      <h1 className="text-2xl font-serif font-bold text-neutral-900 tracking-wide">特定商取引法に基づく表記</h1>
      <p className="text-xs text-neutral-500 mt-1 font-sans">Act on Specified Commercial Transactions</p>
    </div>

    <div className="space-y-4 text-xs leading-relaxed text-neutral-800">
      <div className="divide-y divide-zinc-100">
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          <span className="font-bold text-neutral-700">事業者名（運営組織）</span>
          <span className="md:col-span-2 text-neutral-900 font-medium">ReMEETs 運営事務局（株式会社ビープ）</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          <span className="font-bold text-neutral-700">代表責任者</span>
          <span className="md:col-span-2 text-neutral-900 font-medium">本間 貴（ホンマ タカシ）</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          <span className="font-bold text-neutral-700">所在地</span>
          <span className="md:col-span-2 text-neutral-900 font-medium">東京都渋谷区道玄坂1丁目10番8号 渋谷道玄坂東急ビル2F-C</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          <span className="font-bold text-neutral-700">電話番号</span>
          <span className="md:col-span-2 text-neutral-900 font-medium">050-3187-4490（受付時間：平日 10:00〜18:00）</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          ...
          <span className="md:col-span-2 text-neutral-900 font-medium">
            手紙開封・連絡先開示手数料：1件 600円（税込 / 買い切り型）<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
          ...
          <span className="md:col-span-2 text-neutral-900 font-medium">クレジットカードによる仮売上確保および公的本人確認（eKYC）審査の合格をもって、即時システム上で手紙が開封（解凍）され、連絡先が開示されます。</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 py-4 gap-2">
...
const PricingPage = () => (
  <div className="max-w-4xl mx-auto px-6 py-12 font-sans text-black animate-in fade-in duration-300">
    ...
    <div className="glass-card p-8 md:p-16 text-black space-y-12 bg-white rounded-3xl border border-brand-border shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 bg-white border border-brand-border/80 rounded-2xl space-y-6 flex flex-col justify-between shadow-sm">
          <div className="space-y-4">
            ...
            <h2 className="text-xl font-serif font-bold text-neutral-900">アカウント登録 ＆ 本人確認手続き</h2>
            <div className="flex items-baseline gap-1 border-b border-neutral-100 pb-3">
              <span className="text-5xl font-bold font-serif text-neutral-900">0</span>
      ...
      <section className="p-6 md:p-8 bg-gradient-to-br from-[#487799]/5 to-rose-50/20 border border-[#487799]/20 rounded-3xl relative overflow-hidden space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-brand-border/40 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-serif font-bold text-black">【別枠】サイト安全維持のためのサポーター寄付金</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-2 bg-white/70 backdrop-blur-sm p-5 rounded-2xl border border-[#487799]/20 space-y-4">
            ...
            <ul className="text-[11px] text-neutral-600 space-y-2.5 font-sans">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <span className="block text-[10px] text-neutral-500 mt-0.5">プロフィールや投函ボトルに「温かい支援者」を示す特別なエンブレムが表示されます。</span>
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <span className="block text-[10px] text-neutral-500 mt-0.5">ボトル投函時、情緒ある美しい「桜」「さざ波」などの限定ボトル外観が選べるようになります。</span>
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="space-y-4 bg-neutral-50 p-6 md:p-8 rounded-3xl border border-neutral-200/60">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
          ...
          <div className="bg-white p-4 rounded-2xl border border-zinc-200 text-center space-y-1 shadow-xs">
            <span className="text-neutral-400 text-[11px] font-bold block">2. 安全通信 ＆ 決済手数料</span>
            <span className="text-sm font-bold font-mono text-neutral-800">約 30 〜 40 円</span>
            <p className="text-[10px] text-neutral-500 leading-normal">
              認証SMS（Twilio等）の送信通信料、およびStripe等のセキュア決済基本手数料
            </p>
          </div>
          <div className="bg-white p-4 rounded-2xl border border-zinc-200 text-center space-y-1 shadow-xs">
            <span className="text-neutral-400 text-[11px] font-bold block">3. セキュリティ監査 ＆ AI監視</span>
            <span className="text-sm font-bold font-mono text-neutral-800">約 310 〜 420 円</span>
            <p className="text-[10px] text-neutral-500 leading-normal">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="bg-rose-50/5 border border-rose-200 p-6 rounded-3xl space-y-4">
          <h4 className="font-serif font-bold text-xs text-rose-800 flex items-center gap-1.5">
            <HelpCircle size={15} />
          ...
          <div className="space-y-3 font-sans text-xs">
            ...
            <div>
              <span className="font-bold text-[#112435] block">Q. SNS連携ログイン（LINE/Google）と決済は連動しますか？</span>
              <span className="text-neutral-600 mt-0.5 block leading-relaxed">
...
with open("/app/applet/src/App.tsx", "rb") as f:
...
print(f"Start replacing from line {start_idx+1}: {lines[start_idx][:40]}")
print(f"End replacing at line {end_idx+1}: {lines[end_idx][:40]}")

lines[start_idx:end_idx+1] = [new_code + "\\n"]

print(f"New length of lines: {len(lines)}")

# Write in binary mode to prevent text-mode encoding exceptions.
output_bytes = "".join(lines).encode("utf-8", errors="replace")

with open("/app/applet/src/App.tsx", "wb") as f:
