...
const SCHOOLS_AND_ORGS = [
  ...
  "海鳴り台高校", "茜ヶ丘高校", "月見野学園高校", "常盤木高校", "向日葵中学校",
  "青葉台大学 文学部", "緑川理工大学", "星見ヶ丘学園大学", "夕陽丘大学 経済学部", "光陽学院大学",
  "海浜国際大学", "中央アートデザインカレッジ", "武蔵野音楽学院", "あおぞら教育大学",
  "街のヴィンテージ古着店", "地元のITベンチャー創業チーム", "神保町風の老舗古書店",
  "下町のジャズ喫茶", "地元の少年野球リトルリーグ", "市民オーケストラ交響楽団",
  "駅前商店街の文房具店", "アトリエ設計事務所", "老舗の電子パーツ店",
  "地元の少年少女合唱団", "大学の自主映画制作サークル", "学生ボランティア連盟"
];
...
const MEMORY_THEMES: MemorySceneTheme[] = [
  // 1. 吹奏楽部
  {
    ...
    q2Templates: [
      { q: "パート練習の合間に音楽室のベランダで隠れて食べたアイスの味は？", a: "ソーダ味のアイス" },
      { q: "合宿所の夜、パート全員でお揃いで購入したお守りストラップの色は？", a: "スカイブルー" },
      { q: "顧問の先生が練習の合間に差し入れてくれた名物ドリンクは？", a: "スポーツドリンク瓶" },
  ...
  // 2. 野球部
  {
    ...
    q1Templates: [
      { q: "最後の夏の大会で劇的なサヨナラ勝ちを決めた対戦相手の高校名は？", a: "白雲高校" },
    ...
    q2Templates: [
      { q: "部室の冷凍庫に常備してみんなで奪い合った棒アイスの味は？", a: "オレンジ味" },
      { q: "グラウンド整備のトンボ掛けの後に自販機で飲んだ炭酸飲料は？", a: "エナジードリンク" },
      { q: "グローブの手入れ用に二人で愛用していた保革オイルの缶の色は？", a: "黄色い革オイル缶" },
  ...
  // 3. 映画サークル・自主制作
  {
    ...
    q1Templates: [
      ...
      { q: "徹夜の編集作業中に主食にしていたお気に入りのカップ麺は？", a: "特製海鮮ラーメン" },
      { q: "クライマックスの雨宿りシーンを撮影した神社の鳥居の名前は？", a: "日吉神社" },
      { q: "主演俳優の衣装として下北沢の古着屋で買ったレトロなジャケットの色は？", a: "からし色" }
    ],
    q2Templates: [
      { q: "カメラのレンズキャップの裏に印として貼っていたシールの柄は？", a: "ペンギンマーク" },
      { q: "クランクアップの日にみんなで乾杯した瓶ビールの銘柄は？", a: "赤ラベルの瓶ビール" },
  ...
  // 4. ITスタートアップ・開発同期
  {
    ...
    q1Templates: [
      ...
      { q: "徹夜明けにビルの非常階段から見上げた電波塔のライトアップ色は？", a: "オレンジ色" },
    ...
    q2Templates: [
      ...
      { q: "デスクの卓上加湿器の上に置いていた癒やしのフィギュアは？", a: "木彫りのマスコット" },
      { q: "ローンチ成功の記念に社長が全員に奢ってくれた高級アイスの味は？", a: "濃厚バニラアイス" },
      { q: "ホワイトボードの端にずっと消さずに残していた開発スローガンは？", a: "Ship It Fast" },
      { q: "夜食を買いに走った深夜のコンビニでいつも買っていたホットスナックは？", a: "ピリ辛から揚げ" }
    ]
  },
  // 5. 下町の幼馴染
  {
  ...
  // 6. 予備校・大学受験
  {
    ...
    q2Templates: [
      ...
      { q: "合格通知が届いた日の夜に二人で祝杯を挙げた駅前のファミレスは？", a: "駅前のファミレス" }
    ]
  },
  // 7. アルバイト（喫茶・カフェ）
  {
    ...
    q2Templates: [
      { q: "制服のエプロンの右ポケットにいつも常備していた特製メモ帳のサイズは？", a: "手のひらサイズのメモ帳" },
      { q: "バイト代が入った日に二人で食べに行った駅前の焼き鳥屋の名前は？", a: "駅前の焼き鳥屋" },
  ...
  // 8. 恩師への感謝
  {
    ...
    q2Templates: [
      ...
      { q: "修学旅行の夜の見回りの時に先生が着ていたジャージの色は？", a: "エンジ色のジャージ" },
  ...
  // 9. バスケットボール部
  {
    ...
    q2Templates: [
      ...
      { q: "練習後に体育館の裏で二人で分けて飲んだ紙パックジュースは？", a: "紙パックのレモンティー" }
    ]
  },
  // 10. そろばん塾・習い事
  {
    ...
    q1Templates: [
      { q: "そろばん塾の先生が満点のご褒美にくれた文房具のキャラクターは？", a: "人気キャラ消しゴム" },
      { q: "段位認定試験に合格した時に先生から授与された特製そろばんの枠の色は？", a: "紫檀の黒枠" },
      { q: "書道展で特選を受賞した時に二人で書いた四字熟語の課題は？", a: "春風秋雨" }
    ],
    q2Templates: [
      { q: "塾の帰り道にあった自動販売機でいつも買っていた瓶ジュースは？", a: "瓶入りサイダー" },
      { q: "検定試験の前日に先生がみんなに配ってくれた必勝飴の味は？", a: "はちみつ金柑" },
      { q: "文房具入れにしていたカンペンのフタに描かれていたイラストは？", a: "三毛猫のイラスト" }
    ]
  },
  // 11. 旅行・合宿・修学旅行
  {
    ...
    q1Templates: [
      { q: "修学旅行の班別行動で最初に訪れて感動した枯山水庭園の白砂の模様は？", a: "波紋模様" },
    ...
    q2Templates: [
      ...
      { q: "旅館の大部屋で夜中にみんなでこっそり食べたご当地カップ麺は？", a: "天ぷらそばカップ麺" }
    ]
  },
  // 12. 社員寮・新入社員同期
  {
    ...
    q2Templates: [
      { q: "寮の屋上に忍び込んで二人で見た初日の出の方角に見えた名峰は？", a: "東の山並み" },
...
const NATURAL_ADDITIONAL_QA_BANK = [
  ...
  { q: "冬のスキー合宿のロッジで冷えた体を温めるためにみんなで飲んだココアの銘柄は？", a: "特製ホットココア" },
  ...
  for (let i = 0; i < count; i++) {
    ...
    if (existingQ1Set.has(q1) || existingA1Set.has(a1) || existingQ2Set.has(q2) || existingA2Set.has(a2)) {
      ...
      const MOTIF_NOUNS_A2 = [
        "ソーダ味のアイス", "バニラアイスバー", "チョコクランチ", "スナック棒", "スポーツドリンク", "アイソトニック飲料",
        "レモンティー", "フルーツオレ", "ミルメーク", "揚げパン", "ソフト麺", "ラーメンスナック",
        "モナカアイス", "フローズンスムージー", "飲むアイス", "ひとくちアイス", "缶入りコーンスープ", "お汁粉缶", "シトラス炭酸水",
        "チェリー炭酸水", "瓶入りサイダー", "乳酸菌飲料", "乳酸菌ボトル", "コーヒー牛乳", "メロンソーダ",
